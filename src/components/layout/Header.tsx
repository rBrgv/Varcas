...
export function Header() {
  ...
  return (
    <>
      <header className="glass border-b border-primary-100/50 shadow-soft sticky top-0 z-40 backdrop-blur-xl w-full max-w-full">
          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  className="md:hidden text-neutral-700 hover:text-primary-600 transition-colors relative z-50"
                  onClick={() => {
